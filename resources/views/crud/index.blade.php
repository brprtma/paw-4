    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="py-3 px-3">
                    <a href="{{ route('praktikum.create') }}" class="btn btn-primary">Tambah Data</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($members as $member)
                                <tr>
                                    ...
                                    <td>{{ $member->reason }}</td>
                                    <td>
                                        <a href="{{ route('praktikum.edit', $member->id) }}" class="btn btn-info">Edit</a>
                                        <form action="{{ route('praktikum.destroy', $member->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
